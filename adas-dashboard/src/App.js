          ...
          {result.processed_frames && result.processed_frames.length > 0 && (
            <div style={{ background: '#fff', border: '1px solid #e8e8e8', borderRadius: '12px', padding: '1.4rem', marginBottom: '1.25rem' }}>
              ...
              <p style={{ fontSize: '0.78rem', color: '#aaa', marginBottom: '1rem' }}>
                Frame {currentFrame + 1} of {result.processed_frames.length}
              </p>
              <img
                src={`data:image/jpeg;base64,${result.processed_frames[currentFrame]}`}
...
function LiveMode() {
  return (
    <div style={{ background: '#fff', borderRadius: '12px', border: '1px solid #e8e8e8', padding: '3rem', textAlign: 'center' }}>
      <span style={{ fontSize: '3rem' }}>📷</span>
      <h3 style={{ fontWeight: 700, color: '#333', marginTop: '1rem', marginBottom: '8px' }}>Live Monitoring</h3>
      <p style={{ color: '#888', fontSize: '0.9rem', marginBottom: '1.5rem' }}>
        Real-time webcam detection coming soon.
        <br />For now, use <code style={{ background: '#f5f5f5', padding: '2px 6px', borderRadius: '4px' }}>video_detection.py</code> for live monitoring.
      </p>
      <div style={{ background: '#f5f5f5', borderRadius: '8px', padding: '1rem', textAlign: 'left', display: 'inline-block' }}>
        <code style={{ fontSize: '0.85rem', color: '#333' }}>python video_detection.py</code>
      </div>
    </div>
  );
}
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '2rem 1.5rem' }}>
        ...
        <div style={{ marginBottom: '2rem' }}>
          ...
          <p style={{ color: '#666', fontSize: '0.9rem' }}>
            Analyze driver attention using MobileNetV2 — upload an image, video, or use live monitoring.
          </p>
        </div>
